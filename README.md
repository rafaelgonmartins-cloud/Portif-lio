...
3. Gere as versões do site (precisa do [ffmpeg](https://ffmpeg.org) instalado):
   ...
   Para cada vídeo sai em `public/videos/`: o inteiro (1080p, cerca de 4 Mbps, uns 15 a 25 MB),
   uma prévia de 6 s sem som para a grade e a capa. O vídeo do topo sai do item `destaque`
   (`id`, `inicio` e `duracao` em segundos).
